...
// const Utils = require("./utils"); // 유틸리티 파일 로드
...
//   close(logError) {
//     console.log(
//       "Closing connection to " + this._socket.id + ". Error: " + logError
//     );
//     this._socket.disconnect();
//   }
// }

// const ws = new Server(process.env.PORT || 3000);
...
// ws.listen(() => {
//   console.log(`Server is running on port ${ws.port}`);
// });
...
//   close: function (logError) {
//     console.log("Closing connection to " + this.id + ". Error: " + logError);
//     this._socket.disconnect();
//   },
// });

// /**
//  * MultiVersionWebsocketServer using socket.io
//  */
// WS.MultiVersionWebsocketServer = Server.extend({
//   init: function (port) {
//     this._super(port);
...
//       console.log("A client connected: " + socket.id);
//       const connection = new WS.SocketIOConnection(
//         self._createId(),
//         socket,
//         self
//       );
...
// WS.SocketIOConnection = Connection;
const http = require("http");
const socketIo = require("socket.io");
const Utils = require("./utils");
const _ = require("underscore");
